class InteractionsController < ApplicationController
  ...
  def index_jqgrid
    ...
    base_query="select i.id,i.name as interaction_name,interaction_category_id,ic.name as category_name,i.created_at,i.updated_at from interactions i inner join interaction_categories ic on ic.id=interaction_category_id"
    result_set_size=Interaction.count
    ...
    @interactions[:total]=total_pages.to_s
    @interactions[:page]=on_page.to_s
    @interactions[:records]=result_set_size.to_s

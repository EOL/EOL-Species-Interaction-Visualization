...
jQuery.extend(jQuery.jgrid.defaults, { toppager:true,altRows:true,datatype: 'json',mtype: 'GET',height: '100%',viewrecords: true,jsonReader : {repeatitems: false},multiselect: true});
